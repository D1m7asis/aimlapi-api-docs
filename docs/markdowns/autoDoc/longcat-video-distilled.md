...
<a href="https://aimlapi.com/app/?model=longcat/distilled/480p&mode=video" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

Longcat Video Distilled is a family of high-speed video generation models developed by Longcat Video. The models support both text-to-video and image-to-video generation at 480p and 720p resolution, targeting smooth motion and stable frames in the 15–30 fps range.

These distilled variants are optimized for low latency and high throughput, making them suitable for interactive experiences, rapid content production, and other scenarios where quick turnaround is important while preserving visual coherence across frames.
...
{% openapi-operation spec="longcat-video-distilled" path="/v2/generate/video/alibaba/generation" method="get" %}
[OpenAPI longcat-video-distilled](https://raw.githubusercontent.com/aimlapi/api-docs/main/docs/api-references/video-models/longcat/longcat-video-distilled.json)
...
```json5
{
  ...
  'data': [
    {
      'url': 'https://cdn.aimlapi.com/generated-images/longcat/distilled/480p/example-output.png',
