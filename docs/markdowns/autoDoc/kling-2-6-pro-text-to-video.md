...
Kling 2.6 Pro text-to-video is a cinematic video generation model that produces highly detailed, realistic clips with smooth, natural motion. It supports both text and image inputs, making it suitable for creative and production-grade visuals where dynamic movement and high visual fidelity are required.

The model can animate static images into short videos or generate videos directly from textual descriptions, with optional native audio generation. Typical use cases include marketing creatives, promo spots, social media clips, and rapid video mockups that demand polished, cinematic results.
...
{% openapi-operation spec="klingai-video-v2-6-pro-text-to-video" path="/v2/video/generations" method="post" %}
[OpenAPI klingai-video-v2-6-pro-text-to-video](https://raw.githubusercontent.com/aimlapi/api-docs/main/docs/api-references/video-models/kling-ai/klingai-video-v2-6-pro-text-to-video.json)
