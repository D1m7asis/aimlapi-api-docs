...
<a href="https://aimlapi.com/app/?model=blackforestlabs/flux-2-max" class="button primary">Try in Playground</a>
{% endcolumn %}
{% endcolumns %}

## Model Overview

FLUX.2 Max is a pair of high-resolution image generation and editing models developed by Black Forest Labs. They support both text-to-image synthesis and image-to-image transformation, enabling detailed visual creation and refinement from descriptive prompts or existing images.

The models emphasize strong prompt adherence and consistent visual output, making them suitable for workflows that demand precise control over style, composition, and content in complex or large-format images.
